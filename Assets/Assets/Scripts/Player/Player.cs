...
public class Player : MonoBehaviour
{
    ...
    private float groundAccelIncrement = 0.1f;
    private float maxGroundAccel = 3.5f;
    private float airAccel = 0f;
    private float airAccelIncrement = 0.01f;
    private float maxAirAccel = 1.2f;
    private float maxGroundVelocity = 30f;
    private float maxAirVelocity = 22.5f;
    private float maxDownforce = 9f;
    private float airDropRate = 2f;
    private float airDropRateIncrement = 0.05f;
